...
if($_SERVER['HTTP_HOST'] == 'makeadiff.in'){
  $root_path = $_SERVER['DOCUMENT_ROOT'].'/apps/fellowship-signup/tasks/';
}
else{
  $root_path = $_SERVER['DOCUMENT_ROOT'].'/makeadiff/apps/fellowship-signup/tasks/';
}
...
<head>
<meta charset="utf-8">
<title>Fellowwship Tasks | File Manager</title>
<meta name="Description" CONTENT="Author: CCP Programmers,">
...
<head>
<meta charset="utf-8">
<title>Fellowship Task Upload File Manager</title>
